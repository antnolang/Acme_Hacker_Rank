...
<form:form action="curriculum/hacker/create.do" modelAttribute="curriculum">
	<form:hidden path="id" />
	...
	<fieldset>
		...
		<acme:textbox code="curriculum.personalData.linkedInProfile" path="personalData.linkedInProfile"/>
	</fieldset>
